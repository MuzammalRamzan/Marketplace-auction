...
export default function CreateItem() {
	...
	const onCreateItem = async () => {
		if (walletState.connected) {
			...
			dispatch(
				balanceChanged({ BNBbalance: res.BNBbalance, CTbalance: res.CTbalance })
			);
							...
							<div className="author author--page">
								<div className="author__meta">
									...
									<h1 className="author__name">
										<a href="author.html">Susa Condrey</a>
									</h1>
									<h2 className="author__nickname">
										<a href="author.html">@condrey21</a>
									</h2>
									...
									<div className="author__code">
										<input
											type="text"
											value="4fgddgwdfgfew5345353fdfdf3454edrgertt4rgre4"
											id="author-code"
										/>
										<button type="button">
											<span>Copied</span>
									...
									<a href="#" className="author__link">
										{' '}
										<i className="far fa-globe"></i> https://example.com
									</a>
								...
								<div className="row">
									...
									<div className="col-12">
										<div className="sign__group">
											<label className="sign__label" for="itemname">
												Item name
											</label>
											<input
												id="itemname"
												...
												placeholder="e. g. 'Fantacy Flower'"
									...
									<div className="col-12">
										<div className="sign__group">
											<label className="sign__label" for="description">
												Description
											</label>
											<textarea
												id="description"
												...
												placeholder="e. g. 'After purchased you will get downloadable zip file'"
